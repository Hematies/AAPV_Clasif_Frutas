...
# CODIGO TOMADO A PARTIR DE AQUEL DE ESTE ENLACE:
# https://github.com/Xilinx/brevitas/blob/master/src/brevitas_examples/imagenet_classification/models/common.py
...
# Se definen a continuación cabeceras (wrappers) de diferentes funciones de la librería de Brevitas:
...
def make_quant_max_pool(
                        kernel_size,
                        stride,
                        padding=0,
                        ceil_mode=False):
    return qnn.QuantMaxPool2d(kernel_size=kernel_size,
                              stride=stride,
